...
public static class MazeGenerator
{
    ...
    public static void InsertItems(Maze maze, Func<MazeItem> itemSource, float percentage, Action collectingAction)
    {
        var insertionsCount = GetInsertionsCount(maze, percentage);
        ...
        for (int i = 0; i < insertionsCount; i++)
        {
            ...
            maze.InsertItem(itemSource.Invoke(), floorCell, collectingAction);
        }
    }
